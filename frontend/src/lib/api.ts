...
const api = axios.create({
  baseURL: process.env.NEXT_PUBLIC_API_URL || 'https://Ahmad-champ-Elevate-Business-01.hf.space' || 'https://elevate-business-01-un1m.vercel.app/auth/gmail/callback' || 'https://huggingface.co/spaces/Ahmad-champ/Elevate_Business_01'|| 'https://huggingface.co/spaces/Ahmad-champ/Elevate_Business_01.hf.space/auth/callback' || 'http://localhost:8000',
});
